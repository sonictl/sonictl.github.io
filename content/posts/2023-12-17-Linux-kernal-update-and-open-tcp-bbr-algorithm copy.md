---
layout: post
title:  "Linux kernal update and turn on the TCP BBR"
date: 2023-12-17 11:01:45 +0800
categories: linux
slug: p20231217110159
---

# Linux内核升级与开启TCP BBR

Reference: https://github.com/iMeiji



BBR 目的是要尽量跑满带宽，并且尽量不要有排队的情况，效果并不比速锐差。

Linux kernel 4.9+ 才支持 tcp_bbr。下面简单讲述基于 KVM 架构的 virtual p server 如何开启。
