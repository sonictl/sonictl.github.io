...
LittleFS is newly introduced into ESP32 SDK (Aug 2021) . By May2022, platform default ESP32 platform (arduino-esp32) is version 1.0.3, which is not supporting LittleFS (need version higher than 2.0 )



So, in `platformio.ini` file, add the two lines to specify higher version of sdk:

```
;platform = espressif32  ; comment out the original one
platform = https://github.com/platformio/platform-espressif32.git#feature/arduino-upstream
platform_packages = framework-arduinoespressif32 @ https://github.com/espressif/arduino-esp32.git#2.0.1

```

If so, the `<LittleFS.h>` will not be missing.

Try to build the code from [LittleFS examples](https://github.com/espressif/arduino-esp32/blob/master/libraries/LittleFS/examples/LITTLEFS_test/LITTLEFS_test.ino) , upload to ESP32 board you'll see the LittleFS running like below:
...
- writing................................................................
 - 1048576 bytes written in 28348 ms
- reading................................................................
- 1048576 bytes read in 514 ms
Deleting file: /test.txt
- file deleted
Test complete
```

In the [ESP32_LittleFS_platfromIO_example](https://github.com/espressif/arduino-esp32/tree/master/libraries/LittleFS/examples/LITTLEFS_PlatformIO), It mensions an executable tool `mklittlefs`. But in above `littleFS_test` example, the tool is not needed. 



Next, discuss how to upload littleFS files with platform IO.

## 2. Upload file into LittleFS with platformIO

**Build and upload LittleFS filesystem image with platformIO on ESP32 **
...
Ref: [ESP32 integrated littleFS file system](https://www.mischianti.org/2021/04/01/esp32-integrated-littlefs-filesystem-5/)
   ...
   the arduino-esp32 v1.x.x is the default version used by platfromIO, by may 2022 I'm writing this blog.
