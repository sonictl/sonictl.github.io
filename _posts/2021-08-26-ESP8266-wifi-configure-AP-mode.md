...
**Note** that the ESP8266 SmartConfig is another covenient way for wifi password broadcasting while the android app seems not supported by my HomonyOS phone.
